...
class DataManager:
    ...
    def save_final_data(self, data) -> str:
        """
        Update current data and save intermediate results.
        ...
        :return: Path to the saved data file
        """
        print(f"save_final_data called {self.final_output_folder}")
        with open(self.final_output_folder, 'w') as f:
            for item in data:
                f.write(json.dumps(item, ensure_ascii=False) + '\n')
        logging.info(f"Saved {len(data)} items to {self.final_output_folder}")
        return self.final_output_folder
    ...
    def save_final_results(self):
        ...
        :return: Path to the final output folder
        """
        ...
        #         )
        #         self.final_output_folder = self.final_output_folder + "_backup"
        #     final_dir = os.path.dirname(self.final_output_folder)
...
class Recorder:
    ...
    """
    def __init__(self, data_manager: DataManager, step_name: str, save_final: bool = False):
        """
    ...
    def dump(self) -> str:
        ...
        if self.save_final:
            return self.data_manager.save_final_data(data=self.captions)
